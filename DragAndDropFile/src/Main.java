...
public class Main
{
    ...
    public static void doSomeThingWithNewFile(List<File> newFile) {
        //ArrayList<File> files = new ArrayList<File>(newFile.listFiles());
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // System.out.println(newFile.getFileExtension());          https://github.com/google/guava
    }

    public static String splitUpDirectory(List<File> newFile) {
